...
class RnnClasifier(nn.Module):
    def __init__(self,input_size,hidden_size,n_classes,n_layer) -> None:
        ...
        self.rnn = nn.RNN(input_size,hidden_size,n_layer,batch_first=True) # expect an input of [batch,sequence,input_size] 
    ...
    def forward(self,x):
        ...
        out,_ = self.rnn(x,h0) # an out with shape of [100,28,128]
    ...
    for epoch in range(epochs):
        for i,(feature,labels) in enumerate(train_loader):
            ...
            if i % loss_step  == 0:
                ...
                loss_counter = 0
    gr.plotLoss(all_losses,'RNN loss',epochs)
